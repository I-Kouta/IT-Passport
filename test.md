...
- A.**システムの開発や保守の各工程の作業項目**  
共通フレームでは、システム開発等に係る作業項目を、プロセス、アクティビティ、タスクの階層構造で列挙している。共通フレームの適用に当たっては、各作業を取捨選択したり、繰返し実行したり、複数のものを1つに括るなど開発モデルに合わせた使い方をする

ソフトウェア産業界においての共通の物差しとなることを目的として作成された規格。何度か改訂を重ねており、最新バージョンは共通フレーム2013となっている  
・取得者と供給者で用語が統一されていない  
・多くの人が係るためコミュニケーションが複雑  
・役割分担が不明確  
・曖昧な見積りが招くトラブル  
このような問題を解決するため、取得者と供給者双方及びシステム開発に関わる全ての人が、システムライフサイクルの各フェーズにおける作業項目を共通に参照できるよう詳細に記述したり、ソフトウェア取引を明確化したりするための基準が記述されている

- システムを構成するソフトウェアの信頼性レベルや保守性レベルなどの尺度の規定  
ソフトウェアの尺度については規定していない。信頼性レベルや保守性レベル等のソフトウェア属性の定義は、共通フレームの利用者に委ねられている

- システムを構成するハードウェアの開発に関する詳細な作業項目  
共通フレームは、業務分析、業務設計、及びソフトウェアを中心としたシステムの企画、要件定義、開発、運用、保守及びそれらに係る諸活動と対象としている。ハードウェアもシステム開発に含まれ、共通フレーム2013では「ハードウェア実装プロセス」という工程が定義されている。しかし、ハードウェアについては構成の検討、決定、導入、運用、保守だけに留め、ハードウェア開発の詳細な作業項目については記述していない

- 各工程で作成する成果物の文書化に関する詳細な規定  
作成する文書の詳細な規定は行っていない

---
新製品の開発に当たって生み出される様々な成果のうち、特許法による保護の対象となり得るもの

- A.**機能を実現するために考え出された独創的な発明**  
独創的な発明は特許法で保護される。自然の法則や仕組みを利用した発明を保護する

- 新製品の形状、模様、色彩など、斬新的な発想で創作されたデザイン  
工業上有用なデザインは意匠法による保護対象となる

- 新製品発表に向けて考え出された新製品のブランド名  
商品名、サービス名、ブランド名などの固有名称は商標法の保護対象となる

---
複数の企業が、研究開発を共同で行って新しい事業を展開したいと思っている。共同出資によって、新しい会社を組織する形態

- A.**ジョイントベンチャー**  
合弁企業と呼ばれ、複数の企業が出資し合って組織され、相互の利益のために共同で経営を行う会社。出資を分担するので投資リスクを抑えつつ、各企業が持つ強みを活用した事業運営ができることがメリット。一方、事業方針の食い違いによる対立や、技術・ノウハウの流出が起こり得るのがデメリット

- M&A  
合併と買収の略で、吸収合併や買収により他社を子会社化し、自社の経営資源とすることで競争力を強化する経営手法

- クロスライセンス  
2つ以上の企業や団体が自らの持つ特許等の知的財産権の実施を互いに許諾し合うことを指す

- スピンオフ(*spin-off*)  
一般に派生や副産物を表す言葉として認識されているが、経営戦略上のスピンオフは、ある事業目的のため既存の会社の一部を分割し、元の会社との関係を保ったまま別の会社として独立させることを意味する
